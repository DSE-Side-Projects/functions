          ...
          return [
            ...
            fetchData(
              "https://" +
                ...
                '.api.sanity.io/v1/data/query/production?query=*[_type == "app"]',
              {
                method: "get",
                headers: {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
            ...
            return __generator(this, function (_d) {
              switch (_d.label) {
                case 0:
                  ...
                  SITE_URL = doc.url
                  url =
                    "https://api.apiflash.com/v1/urltoimage?access_key=7f3eb66149a5493abd0711522577c96b&format=jpeg&quality=85&response_type=image&transparent=true&url=" +
                    SITE_URL +
                    "&width=1080"
                ...
                case 2:
                  ...
                  resetTimestamp = Number(
                    data.headers.get("x-rate-limit-reset")
                  )
                ...
                case 5:
                  return [
                    4 /*yield*/,
                    _b.apply(_a, [
                      new (_c.apply(Uint8Array, [void 0, _d.sent()]))(),
                    ]),
                  ]
                case 6:
                  buff = _d.sent()
        ...
        case 5:
          return [
            2 /*return*/,
            { body: JSON.stringify(responseBodyArray), statusCode: "200" },
          ]
      }
    })
  })
